...
DURATION=180
WARMUP=15
RESULTS_DIR="/home/myst/AnypointStudio/mule-perf/benchmark-results/trial2"
mkdir -p "$RESULTS_DIR"
...
run_test() {
    ...
    log "━━━ $scenario | c=$concurrency | ${DURATION}s ━━━"
    ...
    # Collect metrics at 25%, 50%, 75% of duration
...
log "╔═══════════════════════════════════════════════╗"
log "║  Trial 2: Sustained Load (180s per test)     ║"
log "╚═══════════════════════════════════════════════╝"
